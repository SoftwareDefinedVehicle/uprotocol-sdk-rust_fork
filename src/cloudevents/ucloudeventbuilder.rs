...
use chrono::Utc;
use protobuf::{well_known_types::any::Any, Enum};
use url::{ParseError, Url};

// cloudevents-sdk
use cloudevents::{Event, EventBuilder, EventBuilderV10};

use crate::cloudevents::UCloudEventAttributes;
use crate::{UMessageType, UUIDBuilder};
...
impl UCloudEventBuilder {
    ...
    /// use up_rust::cloudevents::{ UCloudEventAttributes, UCloudEventBuilder};
